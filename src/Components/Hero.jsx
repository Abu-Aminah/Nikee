      ...
      <div className=" relative h-auto w-auto flex flex-col">
        ...
        >
          <div className="grid items-center mt-28 md:mt-24">
            ...
            sm:text-3xl xsm:text-2xl font-extrabold filter drop-shadow-sm
             text-slate-200"
            >
              {title}
            </h1>
            ...
            rounded-xl my-5 shadow-slate-200 w-[50%] mx-auto "
            >
              {btntext}
            </button>
            <div
              className="grid items-center gap-5 md:gap-3 absolute 
            top-[33vh] lg:top-[27vh] left-0 xl:left-0 w-auto h-auto"
            >
              {videos?.map((val, i) => (
          ...
          <div className="">
            <img
             ...
             lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] 
             transitions-theme -rotate-[25deg] hover:rotate-0
