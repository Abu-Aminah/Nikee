...
const Cart = () => {
  ...
  const onClearCartItems = () => dispatch(setClearCartItems());
  return (
    <>
      <div
     ...
     blur-effect-theme w-full h-screen opacity-100 z-[250] ${
      ...
      >
        <div
          className={`blur-effect-theme h-screen max-w-xl w-full absolute
       right-0`}
        >
          <CartCount
            totalQTY={totalQTY}
          ...
          {cartItems?.length === 0 ? (
            ...
            <div>
              <div
               ...
               scroll-hidden h-[81vh] scroll-smooth py-3"
              >
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <h1
                    className="text-sm rounded bg-theme-cart text-slate-100
                   px-1 py-0.5"
                  >
                    ${totalAmount}
                  </h1>
                ...
                <div className="grid items-center gap-2">
                  ...
                  <button
                    type="button"
                    className="
                   button-theme bg-theme-cart text-white"
                  >
                    Check Out
                  </button>
                </div>
