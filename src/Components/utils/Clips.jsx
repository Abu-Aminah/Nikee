...
const Clips = ({ clip, imgsrc }) => {
  return (
    ...
    duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20
     sm:h-14"
    >
      <img
        src={imgsrc}
     ...
     transition-opacity duration-500"
      />
      <div
        className="bg-white blur-effect-theme w-8 h-8 md:w-5 sm:h-5
      absolute top-11 left-0 right-0 lg:top-8 lg:left-9 
      sm:top-4 sm:left-5 opacity-100 z-[100] flex
